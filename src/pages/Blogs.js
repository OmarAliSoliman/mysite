...
function Blogs() {
  ...
  const sortDataModfied = () => {
    var newBlogs = [...blogs];
    newBlogs.sort((a, b) => (a.date < b.date ? 1 : -1));
    setBlogs(newBlogs);
  };

  const sortTitle = () => {
    var newBlogs = [...blogs];
    newBlogs.sort((a, b) => (a.title > b.title ? 1 : -1));
    setBlogs(newBlogs);
  };

  const sortName = () => {
    var newBlogs = [...blogs];
    newBlogs.sort((a, b) => (a.field > b.field ? 1 : -1));
    setBlogs(newBlogs);
  };
    ...
    <div className="blogs">
      <div className="container">
        <p className="mt-5 blogs-about">
          in this page{" "}
          <span role="img" aria-label="emoji-page">
            📜
          </span>{" "}
          i will mention kind of toutorail, blogs and courses you can stydy it
          or read it to imporove your skills and be proffesional in your field{" "}
          <span role="img" aria-label="emoji-boy">
            🕺
          </span>
        ...
        <div className="row mt-1 mb-3">
          ...
          <div className="col-sm-12 col-md-12 mt-3">
            ...
            <div className="filtering filtering-name">
              <button
                name="filterByfield"
                className="shadow mt-2 sort-by-field"
                onClick={(name) => filterField(name)}
              >
                all
              </button>
              <button
