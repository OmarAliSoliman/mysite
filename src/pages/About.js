  ...
  return (
    <div className="about-page">
      <div className="container">
          ...
          <div className="col-lg-12">
            <div className="about-me-content">
              ...
              <div className="skills">
                <h4>Skills</h4>
                <img src="/images/html5.png" style= {{width: '2.5%'}} alt="skill-img" />
                <img src="/images/css3.png" style= {{width: '2.5%'}} alt="skill-img" />
              ...
              <div className="find-me mt-5">
                <h4 className="text-capitalize">find me online: </h4>
                  ...
                  <span><a target="_blank" rel="noopener noreferrer" href="https://twitter.com/Omar_3li_S3ody"><i className="fab fa-twitter"></i></a></span>
        ...
        <div className="row">
          <h4 className="mt-5" style={{width: '90%', 
          margin:'0 auto',
           paddingLeft:'12px'}}
          >Some Of My projects</h4>
