      ...
      <div className="card text-white shadow">
        <div className="card-img-overlay">
         ...
         <img className="card-img" src={blog.icon} alt="Card img" />
          ...
          <p className="card-text"> <a target="_blank" rel="noopener noreferrer" href={blog.link}>{blog.title}</a> </p>
          <span className="auther"> {blog.auther} </span>
          <span className="info"> <span role="img" aria-label="emoji-watch">🕐</span> {blog.info} </span>
